function [A1, b1, A2, b2, At1, At2, fm1, fm2, AL1, bL1, AL2, bL2] = readBreast(gamm)
...
AB = [data2,data3,data4,data5,data6,data7,data8,data9,data10,data11];
