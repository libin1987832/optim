...
[rpk2, normr2, xmin2, Ar2, normKKT3 , faceX2, faceA2] = kktResidual(A, b, x , [], 1);
...
sum(bin)
if normr2<normr1
%    save('test7.mat','A','b','x0')
[normr2 normr1 normKKT3 normKKT2 faceX2 faceA2]
end
