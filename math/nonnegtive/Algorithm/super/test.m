...
[xkC,rkC,countFMC,countNWC,beginNWC,tfC,vkC,rkArrC]=contraction_i(x0,A,b,nf,0.8,maxIter);
rkC=b-A*xkC;
rkC(rkC<0)=0;
dC=norm(rkC);
gC=norm(A'*rkC);
...
[xkP,rkP,countFP,countNP,bNWP,tfP,vkP,rkArrP]=predictFM_i(x0,A,b,nf,3,maxIter);
rkP=b-A*xkP;
rkP(rkP<0)=0;
dP=norm(rkP);
gP=norm(A'*rkP);
