...
x_exact = [];
debug = 0;
[xkh1,iter_GS,error_GS,xA_GS,index_GS] = GuassSeidelNE(A1, b1, x0,1.0,maxit_GS,tol,x_exact,debug);
[xkh2,iter_GS,error_GS,xA_GS,index_GS] = GuassSeidelNE(A2, b2, [x0;0],1.0,maxit_GS,tol,x_exact,debug);
